...
- **选项 4**: 暂停 reset-traffic 服务
- **选项 5**: 启动 reset-traffic 服务

**[配置管理]**
- **选项 6**: 修改 SUI 数据库路径
- **选项 7**: 修改 HTTP API 端口
- **选项 8**: 修改定时任务 Cron 表达式

**[操作功能]**
- **选项 9**: 手动重置流量
- **选项 10**: 查看重置日志 (显示时间和重置方式:手动/自动)
- **选项 11**: 更新脚本到最新版本
...
**日志文件位置**: 重置日志存储在 `/usr/local/s-ui/logs/reset-traffic.log`。日志目录会在服务首次写入日志时自动创建。
